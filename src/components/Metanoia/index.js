...
import meta4 from '@/../public/assets/meta4.jpg';
        ...
        <div className={styles.work}>
            <div className={styles.header}>
                <Image
                    ...
                    width={430}
                    height={700}
                    alt="Metanoia home page"
                />
                <div className={styles.text}>
                    <div className={styles.textHeader}>
                        <div className={styles.title}>
                            <p className={saira_init.className}>
                                <span ref={doigtsRef}>METANOIA</span>
                            </p>
                        </div>
                        <p>
                            <span
                    ...
                    <div className={styles.infos}>
                        <div className={styles.row}>
                            ...
                            <p className={styles.light}>
                                <span ref={julyRef}>April 2025</span>
                            </p>
                        </div>
                        <div className={styles.row}>
                            <p>
                        ...
                        <div className={styles.row}>
                            ...
                            <p className={styles.light}>
                                <span ref={reactRef}>HTML/CSS, GSAP</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className={styles.content}>
                <div ref={containerVideoRef} className={styles.video}>
                    <video
                        ...
                        loop
                        muted
                        poster="/assets/meta1.jpg"
                        width="320"
                        height="240"
                        playsInline
                        controls
                        preload="auto">
                        <source src="/assets/meta.mov" type="video/mp4" />
