...
import ddd3 from '@/../public/assets/Seiko.png';
import ddd4 from '@/../public/assets/aira.png';
                    ...
                    <div className={styles.textHeader}>
                        <div className={styles.title}>
                            <p className={saira_init.className}>
                                <span ref={doigtsRef}>DAN</span>
                            </p>
                            <p className={saira_init.className}>
                                <span ref={deRef}>DADAN</span>
                            </p>
                        </div>
                        <p>
                            <span
                                ...
                                A little personal project about the anime
                                Dandadan.
                            </span>
                        </p>
                    </div>
                    <div className={styles.infos}>
                        <div className={styles.row}>
                            ...
                            <p className={styles.light}>
                                <span ref={julyRef}>February 2025</span>
                            </p>
                        </div>
                        <div className={styles.row}>
                            <p>
                        ...
                        <div className={styles.row}>
                            ...
                            <p className={styles.light}>
                                <span ref={reactRef}>Next.js, Figma, GSAP</span>
                            </p>
                        </div>
                    </div>
                </div>
